...
import os
import json
from model import Base, Card, CardSupply, GameCharacter, Music, MusicArtist, MusicDifficulty, MusicTag, Skill, Unit
...
if not os.path.exists(config.DATA_DIRECTORY_JP):
    ...
    repo = Repo.clone_from(config.DATA_REPOSITORY_JP_URL,
                           config.DATA_DIRECTORY_JP)
else:
    print(
...
if not os.path.exists(config.DATA_DIRECTORY_EN):
    ...
    repo = Repo.clone_from(config.DATA_REPOSITORY_EN_URL,
                           config.DATA_DIRECTORY_EN)
else:
    print(
